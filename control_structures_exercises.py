...
if hours_per_week <= 40:
    weekly_paycheck = hours_per_week * hourly_rate
else:
    weekly_paycheck = hourly_rate * (((hours_per_week - 40) * 1.5) + 40)
...
# 10 for that number.
pick_a_number = input("Please put in your favorite integer ")
#    For example, if the user enters 7, your program should output:
pick_a_number = int(pick_a_number)
pick_a_number
for n in range(1, 11):
    print(f"{pick_a_number} X {n} = {pick_a_number * n}")
